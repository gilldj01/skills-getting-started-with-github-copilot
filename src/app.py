...
activities = {
    ...
    "Track Team": {
        "description": "Train for and compete in track and field events with the school team",
        "schedule": "Mondays and Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Wrestling Team": {
        "description": "Practice wrestling techniques and compete in school tournaments",
    ...
    # School activity
    "Student Council": {
        "description": "Participate in school governance and organize events",
        "schedule": "Tuesdays, 12:30 PM - 1:00 PM",
        "max_participants": 12,
